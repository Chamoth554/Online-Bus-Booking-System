...
<div class="container-fluid">
	<h3>Bus Ticket Booking System</h3>
	<div class="navbar-right">Welcome, '.$_SESSION['user']['uname'].' <a href="/BTS/index.php?logout=1"><button class="btn btn-success ml-3 btn-sm">Logout</button></a></div>
</div></div>';
}
function t_sidebar() {
...
<div class="footer">
	<div class="row p-4">
		<div class="col-md-4">BTBS, owned and operated by Anuruddha PVT. Limited, is a premium online and on-demand service provider committed to make your life convenient, easier and smarter.<br/>© 2024-2028 BTBS · All Rights Reserved</div>
